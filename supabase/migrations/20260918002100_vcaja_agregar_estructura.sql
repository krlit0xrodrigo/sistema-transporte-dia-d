-- =====================================================================
-- 0021 · Agregar estructura extendida a v_caja
--
-- Se agrega el supervisor y el barrio a la vista v_caja para poder
-- utilizarlos en los reportes del dashboard general y en la pantalla
-- de control de montos.
-- =====================================================================
