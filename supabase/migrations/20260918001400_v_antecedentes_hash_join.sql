-- =====================================================================
-- 0020 · Optimización extrema v_antecedentes (Hash Join)
--
-- Reemplaza los LATERAL JOIN por subconsultas agregadas (Hash Join)
-- para evitar los timeouts cuando hay cientos de registros y el
-- optimizador de Postgres elige un mal plan.
-- =====================================================================
