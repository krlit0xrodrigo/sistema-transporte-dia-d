-- =====================================================================
-- 0018 · Corrección de validación de vehículo en uso
--
-- Agrega una validación amigable antes de insertar en chofer_vehiculos
-- para evitar la excepción bruta "ux_vehiculo_activo" de postgres.
-- =====================================================================
...
begin
  ...
  if nullif(p->>'chapa','') is not null then
    ...
    -- NUEVA VALIDACION: Check for active vehicle
