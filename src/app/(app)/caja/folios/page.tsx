...
export default async function Folios() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-xl font-semibold">Talonarios y Folios</h1>
        <p className="text-sm text-slate-500">
          Cada talonario emite folios prenumerados para uso en caja, contratos y vales.
          Esto evita duplicaciones y mantiene un control auditable.
        </p>
      </div>
